    ...
    function searchTemplate() {
        return [
            ...
            '<div class="input-group">',
                '<input class="form-control ng-pristine ng-valid" placeholder="{{\'Search\' | r}}" ng-model="productSearchTerm"/>',
                '<span class="input-group-btn">',
                    '<button type="submit" class="btn btn-primary btn-coupon" ng-disabled="productSearchTerm == null || productSearchTerm == \'\'"><i class="fa fa-search"></i></button>',
                '</span>',
            '</div>',
            '</div>',
            '</form>'
