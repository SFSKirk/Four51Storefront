four51.app.directive('quantityfield', ['$451', 'ProductDisplayService', function($451, ProductDisplayService){
    var obj = {
        ...
        template: '<div class="text-center">'+
            ...
            '<input style="float:none" type="number" ng-disabled="lineitem.Variant.RecordCount > 0 && lineitem.ID" id="451qa_input_qty" placeholder="0" autocomplete="off" class="text-center" ng-change="qtyChanged(lineitem)" ng-if="!lineitem.PriceSchedule.RestrictedQuantity" type="text" ng-required="required" name="qtyInput" ng-model="lineitem.Quantity" ui-validate="\'validQuantityAddToOrder($value, lineitem)\'"/>'+
            '</div>',
        link: function(scope){
